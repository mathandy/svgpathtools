...
class TestGeneration(unittest.TestCase):
    ...
    def test_path_parsing(self):
        ...
        if sys.version_info < (3,):
            float_paths.append('M 600.0,350.0 L 650.0,325.0 A 27.9508497187,27.9508497187 -30.0 0,1 700.0,300.0 L 750.0,275.0')
        elif sys.version_info < (3, 10):
            float_paths.append('M 600.0,350.0 L 650.0,325.0 A 27.95084971874737,27.95084971874737 -30.0 0,1 700.0,300.0 L 750.0,275.0')
        else:
            float_paths.append('M 600.0,350.0 L 650.0,325.0 A 27.950849718747367,27.950849718747367 -30.0 0,1 700.0,300.0 L 750.0,275.0')
